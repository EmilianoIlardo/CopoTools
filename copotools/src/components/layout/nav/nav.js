const Nav = () => {
    return (	<header className="window-header">
    <nav className="navigation">
        <div className="navigation-top">
            <a href="#" className="navigation-item">
                ...
                <span className="navigation-item-title">Dashboard</span>
            </a>
            <a href="#" className="navigation-item active">
                ...
                <span className="navigation-item-title">Pages</span>
            </a>
            <a href="#" className="navigation-item">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="navigation-item-title">Media & Files</span>
            ...
            <a href="#" className="navigation-item">
                ...
                <span className="navigation-item-title">Theme Settings</span>

            </a>
            <a href="#" className="navigation-item navigation-item--notification">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="navigation-item-title">Notifications</span>
        ...
        <div className="navigation-bottom">
            ...
            <a href="#" className="navigation-item">
                <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" width="80" height="80" colors="#b2cba3,#e0df9f,#e7a83e,#9a736e,#ea525f" name="Babe Didrikson" size="80" className="avatar">
                ...
                <span className="navigation-item-title">Your Profile</span>
            </a>
        </div>
    </nav>
</header>);
